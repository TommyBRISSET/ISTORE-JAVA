...
import employe.deleteUser;
import employe.updateUser;
...
/**
 * This class represents a window that prompts the user to enter an ID.
 *
 * <p>
 * Used in the context of updating, deleting, or performing other actions on a user.
 * Validates the entered ID and checks if it exists in the database.
 * </p>
 *
 * <p>
 * The class handles the graphical interface using the Swing library.
 * </p>
 *
 * <p>
 * Example of usage:
 ...
 * </pre>
 *
 * @see employe.updateUser
 * @see employe.deleteUser
 * @see utils.askIDStore
 * @author Tommy Brisset
 * @version 1.0
 */
public class askId extends JFrame {

    /** The Toaster component to display information messages. */
    private final Toaster toaster;

    /** The text field for the user's ID. */
    private intFieldId idField;
    ...
    private JPanel getMainJPanel() {
        ...
        infoLabel.setText("ENTER THE ID OF THE USER : ");
    ...
    private void buttonEventHandler() {
        if (isNumberValid.isAValidNumber(idField.getText())) {
            ...
            dispose();
            if (action == 1) {
                new updateUser(Integer.parseInt(idField.getText()));
            }
            if (action == 2) {
                new deleteUser(Integer.parseInt(idField.getText()));
            }
            if (action == 3) {
                new askIDStore(30, Integer.parseInt(idField.getText()));
            }
        } else {
