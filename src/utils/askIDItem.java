 ...
 * @version 1.0
 */
public class askIDItem extends JFrame {
    ...
    private JPanel getMainJPanel() {
        ...
        infoLabel.setText("ENTER THE ID OF THE ITEM : ");
        ...
        if (isNumberValid.isAValidNumber(idField.getText())) {
            try {
                ...
                if (!resultSet.next()) {
                    ...
                    itemId = resultSet.getInt("inventory_id"); // Affectation de la valeur à itemId
                }
                connection.close();
            ...
            dispose();
            if (action == 10) {
                new deleteItem(Integer.parseInt(idField.getText()));
            }
            if (action == 11) {
                if (itemId != -1) {
                    new updateItem(Integer.parseInt(idField.getText()), itemId);
                } else {
                    toaster.error("Error retrieving item ID.");
                }
            }
        } else {
